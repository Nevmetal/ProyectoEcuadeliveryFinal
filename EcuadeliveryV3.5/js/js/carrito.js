class Carrito {
    ...
    leerLocalStorageFinal() {
        ...
        productosLS.forEach(function (producto) {
            ...
            //let aux = parseFloat(producto.precio) * parseFloat(producto.cantidad);
            row.innerHTML = `
                <td><input type="text" name="imgs" class="form-control " value=${producto.id}></td>
                <td>
                    <input type="number" name="cant" class="form-control cantidad" min="1" value=${producto.cantidad}>
                </td>
            `;
